;(function($) {
 	...
 	wp.customize.controlConstructor['bloghash-design-options'] = wp.customize.Control.extend({
		...
		ready: function() {
			...
			// Range controls.
			control.container.find( '.bloghash-range-wrapper' ).each( function() {
				var $this = $(this);
			...
			control.container.find( 'input.bloghash-range-input' ).on( 'change keyup', function() {
			...
			control.container.on( 'change', '.bloghash-select-wrapper', function(){
				control.update_value();
			});
			...
			// Linked button
			control.container.on( 'click', '.bloghash-spacing-linked', function() {
			...
			// Unlinked button
			control.container.on( 'click', '.bloghash-spacing-unlinked', function() {
