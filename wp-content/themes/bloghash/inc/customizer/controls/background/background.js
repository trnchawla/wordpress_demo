;( function( $ ) {
	...
	wp.customize.controlConstructor['bloghash-background'] = wp.customize.Control.extend({
		...
		ready: function() {
			...
			control.container.find( 'input[type=range]' ).on( 'mousedown', function() {
				...
				range 			= $( this );
				range_input 	= range.parent().children( '.bloghash-range-input' );
				...
				range.mousemove( function() {
					...
					clearTimeout( bloghash_range_input_number_timeout );

					bloghash_range_input_number_timeout = setTimeout( function() {
